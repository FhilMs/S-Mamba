...
def train_net(dataset_name):
    ...
    device = torch.device('cuda:1' if torch.cuda.is_available() else 'cpu')  # working device
    ...
    os.environ["WANDB_API_KEY"] = "3b8676ad9b8c8821b82d12040b615df13f29c657"
    wandb.login()
    ...
    # 初始化最小损失为max
    best_metrics['lowest loss'] =  math.inf
