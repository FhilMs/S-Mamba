...
class Path_Hyperparameter:
    ...
    # load: str = "/root/hx/RSmamba/Official_Remote_Sensing_Mamba-main/semantic_segmentation_mamba/train_palsar_256_0.001_checkpoint/checkpoint_epoch109_Thu May  2 12:32:35 2024.pth"  # Load model and/or optimizer from a .pth file for testing or continuing training
    ...
    downsample_raito = 1
    dataset_name = 'palsar'
    root_dir = '/root/hx/RSmamba/Official_Remote_Sensing_Mamba-main/data'  # the root dir of your dataset
    ...
    log_wandb_project: str = 'train_palsar'  # wandb project name
